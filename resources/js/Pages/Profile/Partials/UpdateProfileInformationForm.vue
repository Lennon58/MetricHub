...
// 1. Declaramos _method: 'PATCH' diretamente nos dados do formulário
const form = useForm({
    _method: 'PATCH',
    name: user.name,
    email: user.email,
...
// 2. Disparamos o post diretamente sem usar form.transform()
const submit = () => {
            ...
            <div>
                ...
                <div class="flex items-center gap-4">
                    <div v-show="!photoPreview">
                        <img :src="user.avatar ? `/storage/${user.avatar}` : `https://ui-avatars.com/api/?name=${encodeURIComponent(user.name)}&background=random`"
