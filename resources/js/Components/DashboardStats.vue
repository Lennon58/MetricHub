...
const getMetricaTotal = (metricas: any[], tipo: string) => {
    ...
    return filtradas.reduce((acc, curr) => acc + Number(curr.valor), 0);
};
...
<template>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-[0_15px_30px_-5px_rgba(0,0,0,0.08)] dark:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.7)] flex justify-between items-start transition-all">
            <div>
                ...
                <div class="mt-3 inline-flex items-center gap-1.5 text-xs font-semibold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800/50 px-3 py-1 rounded-full">
        ...
        <div class="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-[0_15px_30px_-5px_rgba(0,0,0,0.08)] dark:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.7)] flex justify-between items-start transition-all">
            <div>
                ...
                <div class="mt-3 inline-flex items-center text-xs font-semibold text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/60 border border-rose-200 dark:border-rose-800/50 px-3 py-1 rounded-full">
                    Total Registrado
                </div>
            </div>
        </div>
        ...
        <!-- Card 3: Horas & NPS -->
        <div class="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-[0_15px_30px_-5px_rgba(0,0,0,0.08)] dark:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.7)] flex flex-col justify-between transition-all">
